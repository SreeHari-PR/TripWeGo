...
const BookingsChart = ({ bookings }) => {
  ...
  const sortObjectByKeys = (obj, compareFn) => {
    return Object.fromEntries(
      Object.entries(obj).sort(([keyA], [keyB]) => compareFn(keyA, keyB))
    );
  };
  ...
  const groupByWeek = (bookings) => {
    ...
    return sortObjectByKeys(weeklyData, (a, b) => 
  ...
  const groupByMonth = (bookings) => {
    ...
    return sortObjectByKeys(monthlyData, (a, b) => monthOrder.indexOf(a) - monthOrder.indexOf(b));
  };
  ...
  const groupByYear = (bookings) => {
    ...
    return sortObjectByKeys(yearlyData, (a, b) => parseInt(a) - parseInt(b));
  };
